 ...
 * @author edz
 */
public class Updastudent extends javax.swing.JFrame {
    public int x=0;
    /**
    ...
    private void initComponents() {
        ...
        jButton5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                try {
                    ...
                    String op="";
                    if(x==1){
                        op=jTextField2.getText()+","+jTextField4.getText()+","+ -1;
                    }
                    else{
                        op=jTextField2.getText()+","+jTextField4.getText()+","+ jTextField5.getText();
                    }
        ...
        jTextField1.setText("        学 员 修 改 系 统");
