...
public class UpExamine extends javax.swing.JFrame {
    ...
    public int number=0;
    public List<List<String>>listt=new ArrayList<List<String>>();
    /**
    ...
    private void initComponents() {
        ...
        jButton5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                ...
                try {
                    outputStream.write("修改".getBytes());
                } catch (IOException e) {
                    e.printStackTrace();
                }
                try {
                ...
                try {
                    o = new ObjectOutputStream(Sockett.socket.getOutputStream());
                } catch (IOException e) {
                    e.printStackTrace();
                }
                try {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                try {
                    ...
                    if(list.size()==0){
                        ...
                        jTextArea1.setText(lists.get(1));
                        jTextArea2.setText(lists.get(2));
                        jTextArea3.setText(lists.get(3));
                        jTextArea4.setText(lists.get(4));
                        jTextArea5.setText(lists.get(5));
                        if(lists.get(6).equals("A")){
                            jRadioButton1.setSelected(true);
                        }else if(lists.get(6).equals("B")){
                            jRadioButton2.setSelected(true);
                        }else if(lists.get(6).equals("C")){
        ...
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                if (list != null) {
                    ...
                    alist.add(list.get(number - 1).get(0));
                    alist.add(jTextArea1.getText());
                    alist.add(jTextArea2.getText());
                    alist.add(jTextArea3.getText());
                    alist.add(jTextArea4.getText());
                    alist.add(jTextArea5.getText());
                    Enumeration<AbstractButton> radioBtns = buttonGroup.getElements();
                    while (radioBtns.hasMoreElements()) {
                        AbstractButton btn = radioBtns.nextElement();
                        if (btn.isSelected()) {
                            alist.add(btn.getText());
                            break;
                        }
                    }
                    listt.add(alist);
